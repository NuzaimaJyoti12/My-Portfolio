      ...
      <div className="container">
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 justify-between items-center">
            <div>
              <p className="text-[20px] text-[#FF9330] font-bold font-syne pb-2">
                Service
              </p>
              <h1 className="text-[40px] md:text-[64px] font-bold font-syne pb-12 relative after:absolute after:size-[40px] md:after:size-[62px] after:rounded-full after:bg-[#FFB646] after:top-[15px] after:left-[-1px] md:after:left-[-2px] z-[1] after:z-[-1] ">
                My specialties
              </h1>
            </div>
            <div>
              <p className="text-[18px] text-[#08080899]">
          ...
          {/* bottom */}
          <div className="grid grid-cols-1 lg:grid-cols-[auto_1fr] gap-6 mt-12" data-aos="fade-up" data-aos-delay="500">
            ...
            <div className="bg-black rounded-2xl relative px-6 py-9">
              ...
              <div className="absolute bottom-6">
                <h2 className="text-[#FFB646] text-[18px] font-sans">
                  SAY HELLO!
                </h2>
                <h2 className="text-white font-semibold text-[27px] font-syne">
                  hello@nuzaima.com
                </h2>
              </div>
            </div>
